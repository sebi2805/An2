...
values (1,3,1,'Ang.1',2000.675);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (2,1,2,'Ang.2',200.54);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (3,1,2,'Ang.3',500.343);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (4,2,1,'Ang.4',300.67);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (5,2,1,'Ang.5',200.323);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (6,2,1,'Ang.6',400.78);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (7,1,4,'Ang.7',500.33);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (8,1,4,'Ang.8',300.43);
insert into angajati_as(Matricol,Cod_dir,Cod_dep,Nume,Salariu)
values (9,1,1,'Ang.9',700.898);
